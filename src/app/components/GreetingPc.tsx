...
/* ─────────────────────────────────────────────────────────
   GreetingPc — Greeting の PC版（CTAカードあり・lg:2カラム）を温存。
   SP起点で作り直す Greeting.tsx と後でマージするための退避ファイル。
   ※ HeroPc.tsx と同様、App.tsx では import せず保持のみ。
   ───────────────────────────────────────────────────────── */
export default function GreetingPc() {
  return (
    <section
      id="greeting"
